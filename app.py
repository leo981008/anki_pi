...
@app.route('/api/ai_sentence', methods=['POST'])
def api_ai_sentence():
    data = request.json
    word = data.get('word')
    ...
    prompt = f"Please generate a simple English example sentence for the word '{word}'. Only return the sentence, nothing else."
